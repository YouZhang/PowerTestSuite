...
if __name__ == '__main__':
    ...
    enableSocWatch()
    enableEmon()
    enableISVApp('tool\potplayer\PotPlayerSetup.exe')
    waitProc('PotP')
    enableISVApp('tool\potplayer\PotPlayerSetup64.exe')
    waitProc('PotP')
    enableISVApp('tool\PowerDVD\Setup.exe')
    waitProc('Setu')
